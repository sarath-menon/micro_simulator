...
float PidCascadedController::z_pos_pid(const float e, const float k_p,
...
float PidCascadedController::y_pos_pid(const float e, const float k_p,
                                       const float k_i, const float k_d,
                                       const float dt) {
...
float PidCascadedController::roll_angle_pid(const float e, const float k_p,
                                            const float k_i, const float k_d,
                                            const float dt) {
